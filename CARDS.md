...
| `Résonance` | Enchantement | Se déclenche quand un Mort-Vivant allié attaque. |
...
| 09 | Horde Mineure | ⚔️ | 3 | 1 | 1 | Arrivée : Invoque 2 Rampants 1/1. | Un seul ne fait pas peur. Mais il n'est jamais seul. |
...
| 34 | Tombeau Ambulant | ⚔️ | 5 | 3 | 8 | REMPART Dernier Souffle : Invoque 3 Rampants 1/1. | Il n'était pas un monstre. Il était une fosse commune. |

### Légendaires

| ID | Nom | Lane | ⬡ | ⚔ | ♥ | Effet | Flavour |
|:---:|---|:---:|:---:|:---:|:---:|---|---|
| 35 | Le Médecin de la Peste | 🛡️ | 6 | 0 | 4 | Éveil : Invoque un Mort-Vivant aléatoire de coût ≤3. | Il soignait les vivants autrefois. Il a simplement changé de patientèle. |
...
| 38 | Léviathan Putréfié | ⚔️ | 7 | 8 | 10 | REMPART Arrivée : Mort-Vivants alliés +2/+2. | Les mers l'ont recraché. Elles non plus ne voulaient plus de lui. |
| 39 | La Faucheuse | ⚔️ | 7 | 7 | 6 | Arrivée : Détruit un serviteur ciblé ennemi et le ressuscite sous votre contrôle sans ses effets. | Elle ne prend pas les âmes. Elle redistribue les corps. |
...
|---|:---:|---|---|---|
| Souffle du Charnier Ancestral | 3 | Rare | Tous les serviteurs alliés gagnent +1/+1 de façon permanente. | Un seul souffle, et chaque carcasse debout se redresse un peu plus droite. |
...
| `Renfort` | Enchantement | Se déclenche chaque fois qu'**un serviteur allié** arrive sur le champ de bataille. |
| `Présence` | Enchantement | Effet **passif continu** actif tant que l'enchantement est en jeu. |
| `Résonance` | Enchantement | Se déclenche quand **un Humain allié** attaque. |
| `Sacrifice` | Rituel | Requiert de détruire un ou plusieurs serviteurs alliés pour activer l'effet. |
...
| Nom | ⬡ | Rareté | Effet | Flavour |
|---|:---:|---|---|---|
| Bénédiction du Front | 3 | Rare | Tous les serviteurs alliés en rangée Avant gagnent ÉGIDE. | La ligne ne recule pas. La bénédiction, elle, ne s'use jamais deux fois de la même façon. |
...
| `Renfort` | Enchantement | Se déclenche chaque fois qu'un serviteur allié arrive sur le champ de bataille. |
| `Présence` | Enchantement | Effet passif continu actif tant que l'enchantement est en jeu. |
| `Résonance` | Enchantement | Se déclenche quand un Démon allié attaque. |
...
| D20 | Banshee des Abysses | 🛡️ | 4 | 2 | 5 | Arrivée : Inflige Corruption à un serviteur ciblé ennemi. | *Son chant ne tue personne. Il fait juste pourrir ce qui l'entend.* |
...
| D23 | Garde Infernal | ⚔️ | 2 | 1 | 4 | REMPART. Dernier Souffle : Invoque une Larve Infernale 2/1. Pacte 2 : Invoque une Larve Ascendante 1/2 avec RANG INFERNAL à la place. | *Il ne meurt jamais vraiment seul. Quelque chose se lève toujours après lui.* |
...
| D26 | Architecte du Pacte | 🛡️ | 3 | 2 | 3 | Arrivée : Invoque une Larve Infernale 2/1. Pacte 2 : Invoque une Larve Ascendante 1/2 avec RANG INFERNAL à la place. | *Chaque contrat qu'il signe en engendre un autre, sans fin.* |
...
| D39 | Le Grand Pacte | ⚔️ | 8 | 7 | 6 | Renfort : Détruit un serviteur ennemi ayant un coût de ressource de 2 ou moins. Pacte 4 : Détruit un serviteur ennemi, sans restriction, à la place. | *Il ne demande jamais la permission. Il constate simplement ce que tu es prêt à perdre.* |
...
| Nom | ⬡ | Rareté | Effet | Flavour |
|---|:---:|---|---|---|
| Rite du Sang Renforcé | 4 | Épique | Tous les serviteurs alliés gagnent +2/+0 de façon permanente. | Le sang versé n'appelle pas la pitié. Il appelle la force de frapper plus fort. |
...
| ID | Nom | ⬡ | Rareté | Effet | Flavour |
|:---:|---|:---:|:---:|---|---|
| D40 | Flamme Infernale | 2 | Commune | Inflige 2 points de dégâts à la cible (joueur ou serviteur ennemi). | *Le feu ne fait pas de distinction. Il te lèche un peu au passage.* |
...
| D44 | Étreinte du Gouffre | 2 | Commune | Inflige Gel à un serviteur ciblé ennemi jusqu'au début de votre prochain tour. | *Le froid des Abysses n'épargne personne, pas même celui qui l'invoque.* |
...
| D63 | Fléau Écarlate | 4 | Épique | 2 charges | Éveil : Les serviteurs non Démons ennemis subissent -1/-1. Pacte 2 : -1/-1 supplémentaire. | *Le fléau ne fait pas de tri. Il revient juste, patiemment.* |
| D64 | Grand Rituel du Pacte | 8 | Légendaire | 3 charges | Deuil : Ramène en main le dernier Démon allié mort depuis le cimetière. Pacte 3 : Le renvoie directement en jeu à la place. | *"Je ne les ai pas ressuscités. Je les rappelle, un par un, à chaque fois qu'il le faut."* |
...
| D69 | Sceau du Répit | 3 | Rare | Deuil : Votre héros récupère 1 point de vie si le serviteur mort était un Démon allié. | *Chaque perte laisse une trace. Celle-ci, au moins, te profite.* |
| D70 | Symbiose Infernale | 5 | Épique | Présence : Les serviteurs alliés en rangée Arrière gagnent +0/+1 par Démon allié en rangée Avant. | *Ceux de devant brûlent. Ceux de derrière se nourrissent de la chaleur.* |
| D71 | Idole du Grand Pacte | 6 | Légendaire | Quand un serviteur Démon allié attaque, il inflige 1 point de dégât aux serviteurs adjacents à la cible. Pacte 2 : +1 point de dégât supplémentaire. | *On ne l'a pas sculptée. Elle a simplement accepté de rester.* |
...
| `FUSION` | Sacrifice un serviteur adjacent allié : ce serviteur absorbe ses stats restantes ET un de ses mots-clés au choix, de façon permanente. |
| `VIRULENT` | Quand ce serviteur meurt, le serviteur adjacent allié déclenche immédiatement une mutation. |
...
| Renfort | Enchantement | Se déclenche chaque fois qu'un serviteur allié arrive sur le champ de bataille. |
| Présence | Enchantement | Effet passif continu actif tant que l'enchantement est en jeu. |
| Mutation | Enchantement | Se déclenche quand Une Abomination alliée gagne une mutation. |
| Sacrifice | Rituel / Incantation | Requiert de détruire un ou plusieurs serviteurs alliés pour activer l'effet. |
...
| A05 | Ce-Qui-Se-Partage | ⚔️ | 2 | 3 | 1 | Dernier Souffle : Le serviteur adjacent gagne +1/+1 permanent. | *Il ne meurt pas vraiment. Il se répartit ailleurs.* |
...
| A09 | Un-Devenu-Plusieurs | ⚔️ | 3 | 1 | 1 | Arrivée : Invoque 2 Amas Informes 1/2. | *Il n'a jamais compris qu'il était censé rester seul.* |
...
| A20 | Doigt-Dans-les-Nerfs | 🛡️ | 4 | 2 | 5 | Arrivée : Réduit l'ATK d'un serviteur ciblé ennemi de 1 jusqu'à la fin du prochain tour de votre adversaire. | *Un seul contact suffit à dérégler ce qui reste de coordination.* |
...
| ID | Nom | Lane | ⬡ | ⚔ | ♥ | Effet | Flavour |
|:---:|---|:---:|:---:|:---:|:---:|---|---|
| A24 | Le Premier Écart | ↕️ | 4 | 3 | 3 | Arrivée : Tous vos Abomination alliée mutent immédiatement. | *Tout a commencé par une simple erreur de forme. Rien ne s'est arrêté depuis.* |
| A25 | La Faim Cuirassée | ⚔️ | 5 | 6 | 4 | RAVAGE, ASSIMILATION | *Chaque mort autour d'elle l'épaissit un peu plus.* |
| A26 | Semeur de Nœuds | 🛡️ | 3 | 2 | 3 | FUSION. Attaque : Invoque un Amas Informe 1/2. | *Il ne construit rien. Il fait pousser.* |
...
| A31 | Le Sculpteur Sans Mains | 🛡️ | 4 | 2 | 4 | Arrivée : un serviteur ciblé allié gagne un mot-clé Abomination de ton choix, de façon permanente. | *"La forme n'est qu'une suggestion. Je préfère négocier."* |
...
| A34 | Ce-Qui-A-Cessé-de-S'arrêter | ⚔️ | 5 | 3 | 8 | REMPART, ASSIMILATION. Dernier Souffle : Invoque 3 Amas Informes 1/2. | *Elle n'était pas un monstre. Elle était une croissance qu'on a laissée trop longtemps.* |
...
| Nom | ⬡ | Rareté | Effet | Flavour |
|---|:---:|---|---|---|
| Chant Dévorant | 4 | Épique | Tous les serviteurs alliés gagnent VENIN MORTEL. | Le chant ne demande rien. Il se contente de rappeler à la chair ce qu'elle doit faire. |
...
| ID | Nom | ⬡ | Rareté | Effet | Flavour |
|:---:|---|:---:|:---:|---|---|
| A40 | Morsure de l'Air | 2 | Commune | Inflige 2 points de dégâts à un serviteur ciblé ennemi. S'il survit, il perd 1 ATK de façon permanente. | *Ce qui ne tue pas ronge quand même.* |
| A41 | Premier Tressaut | 1 | Commune | Un serviteur ciblé allié déclenche immédiatement une mutation. | *Il n'a pas eu le temps de choisir. Peu importe.* |
...
| A43 | Partage Forcé | 2 | Rare | Sacrifice 1 : Le serviteur adjacent absorbe ses stats restantes de façon permanente. | *Rien ne se perd. Tout se recompose.* |
| A44 | Sommeil Qui Ronge | 2 | Commune | Gèle un serviteur ciblé ennemi un tour. À la fin du gel, il subit une mutation forcée : Dégénérescence. | *Le froid ne le tue pas. Il le laisse simplement pourrir sur place.* |
| A45 | Appétit Ciblé | 3 | Rare | Détruit un serviteur ennemi ayant 2 HP ou moins ; Une Abomination ciblé alliée gagne +1/+1 permanent. | *Rien ne se jette. Tout se digère.* |
...
| A49 | Sursaut Final | 3 | Épique | Carnage : le prochain Abomination alliée qui meurt ce tour ressuscite comme Amas Informe 1/1 (une seule fois). | *Une dernière contraction. Ça suffit parfois à repartir.* |
| A50 | Fracture Vivante | 2 | Rare | Détruit un enchantement ou équipement ennemi. Si enchantement : Une Abomination ciblé alliée mute immédiatement. | *La corruption ne respecte pas la magie. Elle la digère aussi.* |
| A51 | Emprunt Instantané | 1 | Commune | Une Abomination ciblé alliée copie un mot-clé présent sur n'importe quel autre serviteur en jeu (allié ou ennemi). | *Il n'a rien inventé. Il a juste regardé, et pris.* |
...
| ID | Nom | ⬡ | Rareté | Charges | Effet | Flavour |
|:---:|---|:---:|:---:|:---:|---|---|
| A53 | Rituel de la Forme Jamais Fixée | 5 | Épique | 3 charges | Éveil : Une Abomination aléatoire alliée mute immédiatement. | *Le cercle ne s'arrête jamais de proposer de nouvelles formes.* |
...
| A55 | Cercle de l'Assemblage | 5 | Épique | 2 charges | Sacrifice (deux serviteurs adjacents alliés) : fusionne-les en un seul serviteur cumulant leurs stats restantes et tous leurs mots-clés. | *Deux corps entrent. Un seul en ressort — plus grand.* |
...
| A57 | Rituel de la Chair Qui Recoud | 4 | Rare | 3 charges | Éveil : l'Abomination alliée avec le moins de HP restaure 2 HP. | *La chair se répare mal. Elle se répare quand même.* |
...
| A64 | Grand Retour Sous une Autre Forme | 8 | Légendaire | 3 charges | Deuil : ramène en main l'Abomination alliée la plus récemment morte ; elle coûte 1 de moins et mute dès qu'elle est rejouée. | *"Je ne les rappelle pas. Je les laisse simplement finir de devenir autre chose."* |

## Enchantements

| ID | Nom | ⬡ | Rareté | Effet | Flavour |
|:---:|---|:---:|:---:|---|---|
| A65 | Autel Qui Ne Reconnaît Rien | 3 | Rare | Deuil : Une Abomination aléatoire alliée mute. | *Chaque mort nourrit l'autel. L'autel, lui, ne rend jamais la même forme deux fois.* |
...
| A68 | La Terre Qui Refuse de Garder | 5 | Épique | Deuil : le serviteur mort allié revient en jeu à la fin du tour avec 1 HP, transformé en Abomination (perd sa race d'origine, gagne MUTATION). Une seule fois par serviteur. | *Le sol ici ne garde rien. Il rend, mais jamais tel quel.* |
...
| A70 | Lien Sans Membrane | 5 | Épique | Présence : Les serviteurs alliés en rangée Arrière gagnent +0/+1 par Abomination alliée en rangée Avant. | *Ceux de devant absorbent. Ceux de derrière en profitent.* |
...
- **A49 Sursaut Final** : au lieu d'attendre une mort Abomination plus tard dans le tour (délai non supporté pour un Éphémère), ressuscite immédiatement la dernière Abomination morte alliée (`ResurrectLast`).
