...
static func _add_news_item(menu, date: String, title: String, body: String, kind: String, is_featured: bool = false) -> void:
	...
	if is_event:
		...
		badge.add_theme_font_size_override("font_size", Typography.MICRO)
		badge.add_theme_color_override("font_color", ACCENT_EVENT)
		item.add_child(badge)

	var date_label := Label.new()
	date_label.text = date
	date_label.add_theme_font_size_override("font_size", Typography.BODY)
	...
	title_label.add_theme_font_size_override("font_size", Typography.SECTION)
	...
	read_more.add_theme_font_size_override("font_size", Typography.BODY)
